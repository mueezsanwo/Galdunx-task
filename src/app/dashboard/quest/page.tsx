...
const QuestPage: React.FC = () => {
  return (
    <div className="w-full max-w-[1440px] px-4 py-8 mx-auto flex flex-col xl:flex-row flex-col-below-xl gap-11">
      {/* Large Card Section */}
      <div className="w-full xl:w-[741px] lg:ml-5 border border-white/15 rounded-[10px] p-4 bg-white/2 flex flex-col">
